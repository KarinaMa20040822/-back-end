                ...
                <table class="products-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%= rs.getInt("productsDescribe") %></td>
                            <td><%= rs.getInt("instock") %></td>
                            <td>NT$<%= rs.getString("defaultPrice") %></td>
							<td><%= rs.getInt("defaultCPU") %></td>
							<td><%= rs.getInt("defaultGPU") %></td>
							<td><%= rs.getInt("defaultRAM") %></td>
							<td><%= rs.getInt("defaultMEM") %></td>
							<td><%= rs.getInt("defaultBW") %></td>
                            <td>
                                <button>編輯</button>
                                <button>刪除</button>
                            </td>
