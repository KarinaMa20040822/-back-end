...
<%
    ...
    String userPwd = request.getParameter("password"); // 修改变量名避免重复
    String confirmPwd = request.getParameter("confirm-password"); // 修改变量名避免重复
    String email = request.getParameter("email");
    String address = request.getParameter("address");

    if (username != null && !username.isEmpty() && userPwd != null && !userPwd.isEmpty() 
        && confirmPwd != null && !confirmPwd.isEmpty() && email != null && !email.isEmpty() 
